module.exports = {
  ...
  /**
   * Used to tell to server that a player need to receive new pieces
   * Data to sent: {roomName, playerName}
   */
  GENPLAYERFLOW: "genPlayerFlow",
  ...
  /**
   * Used to tell if the genPlayerFlow is successful
   * Data to sent: {error: {type, message}} || {success}
   */
  GENPLAYERFLOW_RESPONSE: "genPlayerFlowResponse",
